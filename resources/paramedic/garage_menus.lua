...
if settings.force == "LifeMed" then
	--LifeMed
	cars = {
        {"Ambulance E450", {model="ambulance",type=""},{"ems probationary", "ems paramedic", "ems doctor", "ems specialist", "ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
        ...
        {"CVPI", {model="cvpifd",type=""},{"ems probationary", "ems paramedic", "ems doctor", "ems specialist", "ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
        --{"Tahoe", {model="sheriff2",type=""},{"ems specialist", "ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
        {"Explorer", {model="fire1",type=""},{"ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
    }
...
elseif settings.force == "FDNY" then
	...
	cars = {
        ...
        {"Explorer", {model="police5",type=""},{"ems probationary", "ems paramedic", "ems doctor", "ems specialist", "ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
        {"Tahoe", {model="sheriff2",type=""},{"ems specialist", "ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
        {"CVPI", {model="cvpifd",type=""},{"ems lieutenant", "ems captain", "ems asst. chief", "ems chief"}},
    }
end
