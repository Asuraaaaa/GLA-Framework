...
AddEventHandler('HOSPITAL:released', function(from)
	...
	TriggerClientEvent('chatMessage', -1, "SYSTEM", {200,0,0}, name.." released from the hospital and has began a new life.")
end)

RegisterServerEvent('HOSPITAL:reminder')

AddEventHandler('HOSPITAL:reminder', function(from, seconds)
	TriggerClientEvent('chatMessage', from, "SYSTEM", {200,0,0}, "You have "..tostring(seconds).." more seconds before you are released from the hospital and begin a new life.")
end)
