...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
			...
			if DoesEntityExist(ped) and not IsEntityDead(ped) and not IsPedInAnyVehicle(ped, true) and not IsPauseMenuActive() and IsPedArmed(ped, 7) and IsControlJustPressed(1, 246) then -- INPUT_DROP_WEAPON (F9)
