...
-----------------------------DISPLAY-----------------------------------------
----------------------------------------------------------------------------
TriggerEvent('es:addCommand', 'dirtycash', function(source, args, user)
	local source = tonumber(source)
	local data = user.getJobData()
  ...
  TriggerEvent('f:getPlayer', source, function(user)
    TriggerClientEvent('chatMessage', source, 'INFO', {255, 255, 100}, "Your current Job is: ".. data.name )
   -- TriggerClientEvent('chatMessage', source, 'INFO', {255, 255, 100}, "Cash: $".. user.getMoney() )
    TriggerClientEvent('chatMessage', source, 'INFO', {255, 255, 100}, "Dirty Cash: $".. user.getDirty() )
    --TriggerClientEvent('chatMessage', source, 'INFO', {255, 255, 100}, "Bank Balance: $".. user.getBank() )
     --"\n JOB LIST:\n Unemployed = 1 \n police = 2 \n Pharmacist = 3 \n Miner = 9 \n bucheron = 7 \n Farmer = 6 \n Fisher = 10 \n Brewer = 12 \n vigneron = 13 \n paramedic = 15 \n mechanic =16 \n taxi = 17" )
    CancelEvent()
  end)
end)	
