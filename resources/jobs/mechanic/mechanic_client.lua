...
Citizen.CreateThread(function()
    while true do
        ...
        if isMechanic then
            ...
            if inService then
                inamount = 0.03
                drawMechTxt(0.283, 0.89, 0.25, 0.03, 0.50,mechanic_nbMissionEnAttenteText,255,255,255,255,6)
            end
        end
        ...
        if mechanic_call_accept ~= 0 then
            if mechanic_call_accept == 1 then
                drawMechTxt(0.283, 0.89 - inamount, 0.25, 0.03, 0.50,TEXT.CALL_INFO_OK,255,255,255,255,6)
            else 
                if mechanic_nbMechanicInService == 0 then
                    drawMechTxt(0.283, 0.89 - inamount, 0.25, 0.03, 0.50,TEXT.CALL_INFO_NO_PERSONNEL,255,255,255,255,6)
                elseif mechanic_nbMechanicDispo == 0 then
                    drawMechTxt(0.283, 0.89 - inamount, 0.25, 0.03, 0.50,TEXT.CALL_INFO_ALL_BUSY,255,255,255,255,6)
                else
                    drawMechTxt(0.283, 0.89 - inamount, 0.25, 0.03, 0.50,TEXT.CALL_INFO_WAIT,255,255,255,255,6)
                end
            end  
        end
    end
