...
AddEventHandler('login:SpawnFreeze', function()
  Citizen.CreateThread(function()
    ...
    SetEntityCoords(ped, -194.42086791992,-903.03161621094, 163.43580627441)
  end)
end)
...
AddEventHandler('login:UnFreeze', function(coords)
  ...
  Citizen.CreateThread(function()
    ...
    if coords == nil then
    	...
    	--OpenClothes()
    	--if save() then
        SetEntityCoords(ped, -210.608, -1021.36, 30.1405) -- spawn @ airport everytime
    else
...
function EnableCCGui(enable, name1, dob1, gen1, height1, name2, dob2, gen2, height2, name3, dob3, gen3, height3)
    ...
    if name1 == 1 or name1 == "" or name1 == " " or name1 == "" then
        name1 = ""
        dob1 = ""
        gen1 = ""
        height1 = ""
    ...
    if name2 == 1 or name2 == "" or name2 == " " or name2 == "" then
        name2 = ""
        dob2 = ""
        gen2 = ""
        height2 = ""
    ...
    if name3 == 1 or name3 == "" or name3 == " " or name3 == "" then
        name3 = ""
        dob3 = ""
        gen3 = ""
        height3 = ""
