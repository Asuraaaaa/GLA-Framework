...
Citizen.CreateThread(function()
    while true do
        ...
        if(IsPedInAnyVehicle(GetPlayerPed(-1), false))then
        	...
        	DrawRect(0.068 + (water/1932.3671497)/2,0.8,water/1932.3671497,0.008295,0,125,255,walpha)
	        ...
	        DrawRect(0.1215 + (0.0345)/2,0.8,0.0345,0.008295,0, 255, 30,75)
	        DrawRect(0.1215 + (currentfuel/2898.55072464)/2,0.8,currentfuel/2898.55072464,0.008295,0, 255, 30,fualpha)
