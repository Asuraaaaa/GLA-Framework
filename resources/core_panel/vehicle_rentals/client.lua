...
rental_cars = {
    {title = "Cars", vehicles = {
        ...
        {name = "2008 Chevrolet Trailblazer", price = 4500, model = GetHashKey("trailblazer")},
        {name = "2017 Subaru BRZ t-S", price = 2500, model = GetHashKey("brz")},
        {name = "2014 Subaru WRX", price = 5200, model = GetHashKey("subwrx")},
        ...
        {name = "2017 Ford Raptor", price = 7500, model = GetHashKey("raptor2017")},
        {name = "2017 BMW 750li", price = 4900, model = GetHashKey("750li")},
        {name = "2016 VW Golf GTI", price = 3000, model = GetHashKey("mk7")},
        {name = "2003 BMW M5 E39", price = 4200, model = GetHashKey("m5")},
        {name = "2016 Dodge Charger Hellcat", price = 12000, model = GetHashKey("hellcatom")},
        {name = "2016 Porsche 911 TurboS", price = 25000, model = GetHashKey("911turbos")},
        {name = "2004 Nissan GT-R R34", price = 20000, model = GetHashKey("skyline")},
        {name = "1998 Toyota Supra", price = 20000, model = GetHashKey("supra")},
        {name = "2015 Corvette C7 Z06", price = 4500, model = GetHashKey("c7")},
        {name = "2015 Nissan GTR R35", price = 30000, model = GetHashKey("gtr")}, 
        {name = "2015 Lamborghini Aventador", price = 50000, model = GetHashKey("aventador")},
    ...
    {title = "Motorcycles", vehicles = {
        {name = "Yamaha R6", price = 550, model = GetHashKey("r6")},
...
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
function carRental()
    Menu.SetupMenu("carrental_main","Rentals")
...
function subRentals(title,cvehicles)
    ...
    Menu.SetupMenu("carrental_submenu","Rentals")
...
emplacement_vehiclerentals = {
    ...
    {name="Vehicle rentals", colour=48, id=225, x=-904.39,y=-2337.38,z=6.71,inside={-905.96,-2333.15,6.71,62.03,62.16},exit={-905.96,-2333.15,6.71,62.16}},
}
