...
weapons = {
    ...
    ["f"] = {
        ...
        {"Assault Rifle", 2, {name="AK-47",price=200000,license=5,model="WEAPON_ASSAULTRIFLE"}},
...
gun_emplacement_grove = {
    --{name="Grove St. Gun Shop", colour=4, id=110, x=7.7238087654114, y=-1894.3465576172, z=23.7},
    --{name="Grove St. Gun Shop", colour=4, id=110, x=-1000.4946899414, y=4848.3916015625, z=275.8},
    {name="Grove St. Gun Shop", colour=4, id=110, x=1965.1397705078, y=3819.7724609375, z=32.396926879883},
}
