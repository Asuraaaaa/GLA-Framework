                ...
                for i = 1, #BannedVehicles do
                    ...
                    if GetEntityModel(cVeh) == vehicle then
                        if not banned then
                            ...
                            TriggerServerEvent("FAC:BanCheater", "Banned For illegal vehicle usage: "..vehicle_name.."")
                        end
                    end
                end
            end
    ...
    while true do
        ...
        if not isAdmin then
            if GetEntityHealth(GetPlayerPed(-1)) > 200 then
                if not banned then
                    banned = true
                    TriggerServerEvent("FAC:BanCheater", "Banned For illegal health modifications.")
                end
            end
        end
    end
