...
GUI.titleText = {250, 0, 0, 255, 1} ------- Color of title text                                   --
GUI.titleRect = {0, 0, 0, 255} ------------- Color of rectangle [title]                       --
GUI.optionText = {250, 0, 0, 255, 6} ------ Color of option text                                  --
...
menuYModify = 0.1174 -------------------- Default: 0.1174   ------ Top bar                		--
menuYOptionDiv = 3.56 ------------------ Default: 3.56   ------ Distance between buttons 		--
menuYOptionAdd = 0.142 ------------------ Default: 0.142  ------ Move buttons up and down 		--
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
--==============================================================================================--
--                                           Settings                                           --
--==============================================================================================--
