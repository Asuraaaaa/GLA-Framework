itemlist = {
	...
	{n="GPS", id=99, cu=0},
	{n="Phone", id=100, cu=0},
	{n="Hand Cuffs", id=101, cu=0},
	{n="Driver's License", id=102, cu=0},
	{n="Fake Driver's License", id=103, cu=0}
}
...
illegalItems = {
	...
	{n="Body Armour", id=39},
	{n="Hand Cuffs", id=101},
	{n="Fake Driver's License", id=103}
}
...
function createUser(source, data)
	...
	--self.apartment = data["Apartments"]
	self.coords = {x = -208.037, y = -1018.613, z = 30.138}
	self.session = {}
	...
	f.wipeCharacter = function(id)
		...
		self.weapons[id] = {}
		self.lastcoords[id] = {x = -208.037, y = -1018.613, z = 30.138}
		self.CharcterID = 0
		self.identity = 0
	end
	...
	f.addQuantity = function(itemid, quantity)
		...
		if exist then
	    	...
	    	print("[ERROR - SYSTEM%]::Resource attempted to addQuantity but the item does not exist")
	    	log("errors","[ERROR - SYSTEM%]::Resource attempted to addQuantity but the item does not exist")
	    end
    end
	...
	f.removeQuantity = function(itemid, quantity)
		...
		if exist then
	    	...
	    	print("[ERROR - SYSTEM%]::Resource attempted to remQuantity but the item does not exist")
	    	log("errors","[ERROR - SYSTEM%]::Resource attempted to remQuantity but the item does not exist")
	    end
    end
	...
	f.isAbleToDrop = function(itemid, quantity)
		...
		if exist then
	    	...
	    	print("[ERROR - SYSTEM%]::Resource attempted to DropQuantity but the item does not exist")
	    	log("errors","[ERROR - SYSTEM%]::Resource attempted to DropQuantity but the item does not exist")
	    end
	end
	...
	f.getItemData = function(itemId)
		...
		if exist then
			...
			print("[ERROR - SYSTEM%]::Resource attempted to getItemData but the item does not exist")
			log("errors","[ERROR - SYSTEM%]::Resource attempted to getItemData but the item does not exist")
		end
	end
	...
	f.setMoney = function(m)
		if type(m) == "number" then
			...
			log("errors","[ERROR - SYSTEM%]::There seems to be an issue while setting money, something else then a number was entered.")			
			print('[ERROR - SYSTEM%]::There seems to be an issue while setting money, something else then a number was entered.')
		end		
	end
	...
	f.setBankBalance = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while setting bank, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while setting bank, something else then a number was entered.')
		end		
	end
	...
	f.setDirtyMoney = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while setting dirty money, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while setting dirty money, something else then a number was entered.')
		end		
	end
	...
	f.addDirtyMoney = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while adding dirty money, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while adding dirty money, something else then a number was entered.')
		end	
	end
	...
	f.removeDirtyMoney = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while removing dirty money, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while removing dirty money, something else then a number was entered.')
		end	
	end
	...
	f.addMoney = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while adding money, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while adding money, something else then a number was entered.')
		end	
	end
	...
	f.removeMoney = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while removing money, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while removing money, something else then a number was entered.')
		end	
	end
	...
	f.addBank = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while adding bank, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while adding bank, something else then a number was entered.')
		end	
	end
	...
	f.removeBank = function(m)
		if type(m) == "number" then
			...
			log("errors",'[ERROR - SYSTEM%]::There seems to be an issue while removing bank, something else then a number was entered.')			
			print('[ERROR - SYSTEM%]::There seems to be an issue while removing bank, something else then a number was entered.')
		end	
	end
